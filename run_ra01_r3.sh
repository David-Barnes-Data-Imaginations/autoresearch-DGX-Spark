#!/bin/bash
# RA-01 attempt 3: MoR with balance weight 0.1 (middle ground).
set -e
...
export NANO_ROPE_LOOP=1 NANO_MOR_CHOICES=1,2,4,8
echo "########## RA01 R3: MoR bal=0.1 dep=0.01 1200 ##########"
NANO_MOR=1 NANO_MOR_AUX_WEIGHT=0.01 NANO_MOR_BAL_WEIGHT=0.1 NANO_CKPT_TAG=ra01_R3_mor_bal01_1200 \
  python training/nano_mythos_train.py 2>&1 | tee logs/ra01_R3_mor_bal01_1200.log
echo "R3 DONE"
