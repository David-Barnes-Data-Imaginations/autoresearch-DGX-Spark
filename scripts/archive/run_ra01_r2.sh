#!/bin/bash
# RA-01 attempt 2: MoR with rebalanced aux loss (balance weight 1.0 canonical,
# depth 0.01). R0 baseline already established (= reference 2.306980). Runs only R2.
set -e
...
export NANO_MOR_CHOICES=1,2,4,8
echo "########## RA01 R2: MoR rebalanced (bal 1.0, dep 0.01) 1200 ##########"
NANO_MOR=1 NANO_MOR_AUX_WEIGHT=0.01 NANO_CKPT_TAG=ra01_R2_mor_rebal1200 \
  python training/nano_mythos_train.py 2>&1 | tee logs/ra01_R2_mor_rebal1200.log
echo "R2 DONE"
