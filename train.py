...
# DGX Spark optimizations for unified memory architecture
...
# DGX Spark: Use PyTorch's built-in scaled_dot_product_attention (works on ARM64)
# kernels flash-attn3 doesn't have ARM64 builds
def flash_attn_func(q, k, v, causal=True, window_size=(-1, -1)):
    """Fallback to PyTorch's scaled_dot_product_attention for ARM64 support."""
...
# Model architecture
ASPECT_RATIO = 96  # model_dim = depth * ASPECT_RATIO (increased from 64)
...
MATRIX_LR = 0.06  # learning rate for matrix parameters (Muon) - increased from 0.04
SCALAR_LR = 0.5  # learning rate for per-layer scalars (Adam)
WEIGHT_DECAY = 0.1  # cautious weight decay for Muon - reduced from 0.2 for wider model
ADAM_BETAS = (0.8, 0.95)  # Adam beta1, beta2
WARMUP_RATIO = 0.02  # fraction of time budget for LR warmup (stabilize early)
WARMDOWN_RATIO = 0.2  # fraction of time budget for LR warmdown (find flatter min)
